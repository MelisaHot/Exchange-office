...
public class MenjacnicaClient extends javax.swing.JFrame {
MenjacnicaInterface c;
    String operacija1, operacija2;
    
    public MenjacnicaClient() throws RemoteException, NotBoundException {
        super("Menjacnica");
        initComponents();
        ImageIcon im=new ImageIcon(MenjacnicaClient.class.getResource("/Slike/slika2.jpg"));
        ...
        ImageIcon im1=new ImageIcon(MenjacnicaClient.class.getResource("/Slike/rsd.png"));
        ...
        ImageIcon im2=new ImageIcon(MenjacnicaClient.class.getResource("/Slike/eur.jpg"));
        ...
        ImageIcon im3=new ImageIcon(MenjacnicaClient.class.getResource("/Slike/usd.png"));
        ...
        ImageIcon im4=new ImageIcon(MenjacnicaClient.class.getResource("/Slike/chf.png"));
        ...
        ImageIcon im5=new ImageIcon(MenjacnicaClient.class.getResource("/Slike/gbp.png"));
   ...
   public void connection() throws RemoteException, NotBoundException{
        try {
            Registry reg = LocateRegistry.getRegistry(5454);
            c = (MenjacnicaInterface) reg.lookup("ExchangeService");
...
int br;
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        ...
        if(br>1){
            try {
                ...
                Logger.getLogger(MenjacnicaClient.class.getName()).log(Level.SEVERE, null, ex);
        ...
        try {
            ...
            if(jTextField1.getText().equals("")){
                s = c.menjacnica(operacija1, operacija2, 0);
                jTextField2.setText(s);
            }else{
                s = c.menjacnica(operacija1, operacija2, Float.parseFloat(jTextField1.getText()));
                jTextField2.setText(s);
            }
            } catch (IOException ex) {
                Logger.getLogger(MenjacnicaClient.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
           try {
                    new MenjacnicaClient().setVisible(true);
                } catch (IOException ex) {
                    Logger.getLogger(MenjacnicaClient.class.getName()).log(Level.SEVERE, null, ex);
                } catch (NotBoundException ex) {
                    Logger.getLogger(MenjacnicaClient.class.getName()).log(Level.SEVERE, null, ex);
